            ...
            <div>
              <Container>
                <Row>
                  ...
                  <Col md={-2}>
                    <Link to={"/view/penjualan/" + row.kd_penjualan}><Button className="mr-2" variant="outline-success" block=""><FontAwesomeIcon icon={faEye} /></Button></Link>
              ...
              <div className="back">
                <div>
                  ...
                  <Row>
                    ...
                    <Col xs={1}>
                      <Link to="/add/penjualan"><Button className="mr-2" variant="outline-primary" block="">Create</Button></Link>
                    </Col>
                    <Col xs={2}>
                      <Link to="/detail/penjualan"><Button className="mr-2" variant="outline-secondary" block="">Detail</Button></Link>
                    </Col>
                    <Col>
